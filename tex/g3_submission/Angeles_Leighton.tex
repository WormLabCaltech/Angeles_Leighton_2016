...
\runningtitle{The \cel{} female state} % For use in the footer
...
\begin{abstract}
  ...
  Understanding genome and gene function in a whole organism requires us to
  fully comprehend the life cycle and the physiology of the organism in question.
  Although \cel{} is traditionally thought of as a hermaphrodite, XX animals
  exhaust their sperm after 3 days of egg-laying. Even though \cel{} can live for
  many days after cessation of egg-laying, the molecular physiology of this state
  has not been as intensely studied as other parts of the life cycle, despite
  documented changes in behavior and metabolism. To study the effects of sperm
  depletion and aging of \cel{} during the first 6 days of adulthood, we measured
  the transcriptomes of 1st day adult hermaphrodites; 6th day sperm-depleted
  adults; and at the same time points, mutant \fog{} worms that have a feminized
  germline phenotype. We found that we could separate the effects of biological
  aging from sperm depletion. Young adult \fog{} animals had gene expression
  changes that phenocopied those of sperm-depleted wild-type hermaphrodites, and
  these genes did not change further in \fog{} 6th day adults. Taken together,
  this indicates that changing sperm status causes a change in the internal
  state of the worm. We suggest that spermless animals enter a female state
  distinct from the egg-laying state. The female state is characterized by
  changes in genes enriched in transcription factors canonically associated with
  ...
  period of early aging in the worm.
\end{abstract}
